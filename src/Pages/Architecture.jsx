    ...
    <Container>
      ...
      <Header>
        <Heading
          ...
          para="Explore exteriors from around the world — from brutalist buildings to minimalist structures that will give you a new appreciation for the art of architecture."
        />
        <HeadingSideCard />
      </Header>
      <ImageDiv>
