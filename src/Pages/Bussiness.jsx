...
const Bussiness = () => {
  ...
  return (
    <Container>
      ...
      <Header>
        <Heading
          heading="Business and Work"
          para="Reflecting the realities of the modern workplace in their many forms — from images of remote working and start-ups to shots of engineers and artists at work."
        />
        <HeadingSideCard />
      </Header>
      <ImageDiv>
