  ...
  return (
    <Container>
      ...
      <Header>
        <Heading
          heading="Nature"
          para="Let’s celebrate the magic of Mother Earth — with images of everything our planet has to offer, from stunning seascapes, starry skies, and everything in between."
        />
        <HeadingSideCard />
      </Header>
      <ImageDiv>
