  ...
  return (
    <Container>
      ...
      <Header>
        <Heading
          heading="People"
          para="Real people, captured. Photography has the power to reflect the world around us, give voice to individuals and groups within our communities — and most importantly — tell their story."
        />
        <HeadingSideCard />
      </Header>
      <ImageDiv>
