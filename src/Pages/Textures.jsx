...
const Textures = () => {
  ...
  return (
    <Container>
      ...
      <Header>
        <Heading
          heading="Textures and Patterns"
          para="Whether you’re looking for stunning macro-photography or shots of complex architectural shapes — you’ve come to the right place."
        />
        <HeadingSideCard />
      </Header>
      <ImageDiv>
