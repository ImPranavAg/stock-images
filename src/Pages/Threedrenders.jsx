  ...
  return (
    <Container>
      ...
      <Header>
        <Heading
          heading="3D Renders"
          para="For the first time ever, Unsplash is accepting a new category of images outside of photography. Submit your 3-dimensional images, designed in the software of your choice, rendered into JPEG images."
        />
        <HeadingSideCard />
      </Header>
      <ImageDiv>
